...
const HeroBackground = () => {
  ...
  // const imageUrl =
  //   "https://images.unsplash.com/photo-1765947383567-a7be6d558c6b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDJ8fHxlbnwwfHx8fHw%3D";

  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
      {/* ---- 1. BASE GRADIENT MESH ---- */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary-700 via-primary-600 to-primary-400" />
      {/* <img
        src={imageUrl}
        alt="Hero-image"
